...
export type AliasProvider = "codex" | "kimi" | "zai" | "anthropic";
...
function parseAliasProvider(key: string, value: unknown): AliasProvider | undefined {
  ...
  if (value === "codex" || value === "kimi" || value === "zai" || value === "anthropic") return value;
  warnInvalid(key, '"codex", "kimi", "zai", or "anthropic"', value);
  return undefined;
}
